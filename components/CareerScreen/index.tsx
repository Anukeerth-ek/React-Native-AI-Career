...
import { View, Text, TextInput, TouchableOpacity, ScrollView, KeyboardAvoidingView, Platform, ActivityIndicator, StyleSheet, SafeAreaView } from 'react-native';
...
const sendQuery = async () => {
  ...
  try {
    const response = await fetch('http://10.0.2.2:3000/career/ask-chatbot', {
      ...
      body: JSON.stringify({ resume, query }),
    });
